...
public class BrowserUtilities {
    ...
    public static void waitForPageToLoad(long timeOutInSeconds) {
        ...
        try {
            WebDriverWait wait = new WebDriverWait(com.bookit.utilities.Driver.getDriver(), timeOutInSeconds);
    ...
    public static String getScreenshot(String name) {
        ...
        TakesScreenshot takesScreenshot = (TakesScreenshot) com.bookit.utilities.Driver.getDriver();
    ...
    public static void scitchWindow(String title){
        Set<String> windowHandles = com.bookit.utilities.Driver.getDriver().getWindowHandles();
        for(String window : windowHandles){
            com.bookit.utilities.Driver.getDriver().switchTo().window(window);
            if(com.bookit.utilities.Driver.getDriver().getTitle().equals(title)){
                break;
            }
        }
    }
